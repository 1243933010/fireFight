  ...
  <div>
    ...
    <div class="item-form">
      <div class="item" v-for="(item, index) in bid_units" :key="index">
        ...
        <UploadCom style="width: 50%;" type="see" title="档案汇编" :fileList="item.unit_file_compilation" @updateFile="(e) => updateFile(e, item.unit_file_compilation, index)" />
    ...
    <div>
      <div style="display: flex;flex-direction: row;"
        v-if="projectInfo.bid_open_last_log &&projectInfo.bid_open_last_log.description">
...
export default {
  ...
  computed: {
    ...
    startData() {
      console.log(this.$store.state.projectManagementAdd.thirdData.startData);
      return this.$store.state.projectManagementAdd.thirdData.startData;
    },
    bid_units(){
      let bid_units= this.$store.state.projectManagementAdd.thirdData.startData.bid_units;
  ...
  methods: {
    ...
    async saveFnc(reqBool) {
      ...
      let bid_units =
        this.$store.state.projectManagementAdd.thirdData.startData.bid_units;
      let bid_files_list =
        this.$store.state.projectManagementAdd.thirdData.startData.bid_files_list;
      let project_attachments =
        this.$store.state.projectManagementAdd.thirdData.startData.project_attachments;
      ...
      let form = this.$store.state.projectManagementAdd.thirdData.startData;
