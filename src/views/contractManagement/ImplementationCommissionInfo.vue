  ...
  <div style="height: auto">
    <div class="box1">
      <div class="box-left">
        ...
        <div class="form">
          <div>
            <el-form ref="formInfo" :inline="true" :rules="rules" :disabled="true" :model="formInfo"
              class="demo-form-inline" label-width="100px">

              <el-col :span="12">
                <el-form-item label="抽取序列" prop="choose_no" placeholder="请输入抽取编号">
              ...
              <el-col :span="24">
                <div class="file-form" style="padding-left: 30px;">
                  <div class="file-form-item" v-for="(item, index) in formInfo.agent_receipt" :key="index">
                    ...
                    <div class="right">
                      <UploadCom type="see" :is_required="item.is_required" title="附件" :fileList="item.files"
                  ...
                  <el-upload :action="uploadUrl" :headers="headers" list-type="picture-card" :limit="1"
                    ...
                    <div slot="file" slot-scope="{file,index,list}">
                      <img class="el-upload-list__item-thumbnail"
                        ...
                        :src="file.url" alt="" />
                      <img class="el-upload-list__item-thumbnail"
                        v-if="dialogImageUrl.includes('mp4') || dialogImageUrl.includes('ogg')"
              ...
              <el-col :span="24">
                <UploadCom title="开会前审批稿" type="see" flex="row" :fileList="formInfo.before_meeting"
                  @updateFile="(e) => updateFile(e, formInfo.before_meeting)" style="width: 50%;" />
              </el-col>
              <el-col :span="24">
