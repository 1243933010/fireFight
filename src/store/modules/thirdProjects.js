...
const mutations = {
  ...
  // update_startData_bid_files_list_fail:(state,list)=>{
  //   state.thirdData.startData.bid_files_list = list;
  // },
  // update_startData_bid_units_fail:(state,list)=>{
  //   state.thirdData.startData.bid_units = list;
  // },
  // update_startData_project_attachments_fail:(state,list)=>{
  //   state.thirdData.startData.project_attachments = list;
  // },
  // update_resultData_fail:(state,form)=>{
  //   state.thirdData.resultData = form;
  // },
}
