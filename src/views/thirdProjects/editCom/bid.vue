  ...
  <div>
    ...
    <div>
      <div style="display: flex;flex-direction: row;"
        v-if="projectInfo.reject_log && [20].includes(projectInfo.reject_log.status)&&projectInfo.reject_log.description">
    ...
    <div>
      <div style="display: flex;flex-direction: row;"
        v-if="projectInfo.pass_log && [21].includes(projectInfo.pass_log.status)&&projectInfo.pass_log.description">
        <span style="color: red;font-size: 14px;">部门录入审核意见:</span>
        <el-input :disabled="true" style="max-width: 300px;" type="textarea" :rows="4"
