        ...
        <div class="files">
          ...
          <div>
            ...
            <el-table :data="tableData" style="width: 100%">
              ...
              <el-table-column prop="name" label="上传时间" width="150">
              </el-table-column>
              <el-table-column fixed="right" label="操作" width="200">
                <template slot-scope="scope">
                  <div class="btnn">
                    <div class="btn5">删除</div>
                    <div class="btn4">下载</div>
                  </div>
                </template>
              </el-table-column>
            </el-table>
...
import BasicMsg from '@/views/thirdProjects/editCom/basicMsg.vue'
...
export default {
  mixins: [addMixins],
  components: { Steps, BasicMsg,Dialog },
  data() {
    return {
      tableData:[
        {date:'111',name:'21111'}
