      ...
      <el-form ref="formInfo" :inline="true" :disabled="true" :rules="rules" :model="projectInfo" class="demo-form-inline"
        ...
        <el-col :span="8">
          <el-form-item label="抽取时间" prop="choose_time">
            <el-date-picker value-format="yyyy-MM-dd" v-model="projectInfo.choose_time" type="date" placeholder="请选择抽取时间">
            </el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          ...
          <div class="file-form" style="padding-left: 10px;">
            <div class="file-form-item" v-for="(item, index) in formInfo.purchase_meeting" :key="index">
              <div class="left">
                <div class="title"><span>{{ item.title }}</span></div>
                <div class="input">
                  <el-input type="textarea" :disabled="true" :rows="4" v-model="item.description" placeholder="">
                  </el-input>
                </div>
              </div>
              <div class="right">
