...
const state = {
  ...
  project_attachments:[
    ...
    {type:'force_check_opinion',title:'咨询审查意见书（支队级）',description:'',files:[],is_required:0},
    {type:'other_opinions',title:'其他相关业务部门意见书',description:'',files:[],is_required:0},
    {type:'main_party_committee',title:'大队党委会',description:'',files:[],is_required:1},
