...
0 => '草稿', //提交后，进入初审
        ...
        3 => '待终审', //初审通过
        4 => '项目终审驳回', //录入人员可修改
        5 => '项目终审通过', //录入人员追加代理抽样视频，提交后进入 实施初审
        6 => '待实施初审',
        7 => '实施初审驳回', //录入人员追修改理抽样视频
        8 => '待实施终审', //实施初审通过
        9 => '实施终审驳回', //录入人员追修改理抽样视频
        10 => '实施终审通过', //进入三方项目列表，接下来填写招标信息，保存草稿
        11 => '招标信息草稿', //提交后进入招标信息初审
        12 => '招标信息初审',
        13 => '招标信息初审驳回',
        14 => '招标信息终审',//招标信息初审通过
        15 => '招标信息终审驳回',
        16 => '招标信息终审通过',//招标信息终审通过，需填写开标信息
        18 => '开标信息草稿', //提交后进入开标信息初审
        19 => '开标信息初审',
        20 => '开标信息初审驳回',
        21 => '开标信息终审',//开标信息初审通过
        22 => '开标信息终审驳回',
        23 => '开标信息终审通过',//开标信息终审通过，需填写中标信息
        24 => '中标信息草稿', //提交后进入中标初审
        25 => '中标初审',
        26 => '中标初审驳回', //三方修改招标信息
        27 => '中标终审通过', //接下来维护合同，保存草稿
        28 => '合同草稿',
        29 => '合同初审',//草稿提交后
        30 => '合同初审驳回',
        31 => '待合同终审',//初审通过后
